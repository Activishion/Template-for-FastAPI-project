...
from users.dependencies import get_current_user, get_current_superuser, get_current_active_user
from users.models import UserModel
from users.schemas import UserCreate, Token, User, UserUpdate
...
async def abort_all_sessions(response: Response, user: UserModel = Depends(get_current_user)):
    response.delete_cookie('access_token')
    response.delete_cookie('refresh_token')
